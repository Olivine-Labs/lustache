...
expectations = {
  ...
  { template = "a\n {{!hi}} \nb", value                         = { { type= "text", value= "a\n ", startIndex = 1, endIndex = 3 }, { type= "!", value= "hi", startIndex = 4, endIndex = 10 }, { type= "text", value= " \nb", startIndex = 11, endIndex = 13 } }},
  { template = "a\n{{#a}}{{/a}}\nb", value                      = { { type= "text", value= "a\n", startIndex = 1, endIndex = 2 }, { type= "#", value= "a", tokens= {}, startIndex = 3, endIndex = 8, closingTagIndex=9 }, { type= "text", value= "\nb", startIndex = 15, endIndex = 16 } }},
  { template = "a\n {{#a}}{{/a}}\nb", value                     = { { type= "text", value= "a\n ", startIndex = 1, endIndex = 3 }, { type= "#", value= "a", tokens= {}, startIndex = 4, endIndex = 9, closingTagIndex=10  }, { type= "text", value= "\nb", startIndex = 16, endIndex = 17  } }},
  { template = "a\n {{#a}}{{/a}} \nb", value                    = { { type= "text", value= "a\n ", startIndex = 1, endIndex = 3 }, { type= "#", value= "a", tokens= {}, startIndex = 4, endIndex = 9, closingTagIndex=10 }, { type= "text", value= " \nb", startIndex = 16, endIndex = 18 } }},
  { template = "a\n{{#a}}\n{{/a}}\nb", value                    = { { type= "text", value= "a\n", startIndex = 1, endIndex = 2  }, { type= "#", value= "a", tokens= { { value = "\n", type = "text", startIndex = 9, endIndex = 9 } }, startIndex = 3, endIndex = 8, closingTagIndex=10 }, { type= "text", value= "\nb", startIndex = 16, endIndex = 17 } }},
  { template = "a\n {{#a}}\n{{/a}}\nb", value                   = { { type= "text", value= "a\n ", startIndex = 1, endIndex = 3 }, { type= "#", value= "a", tokens= { { value = "\n", type = "text", startIndex = 10, endIndex = 10 } }, startIndex = 4, endIndex = 9, closingTagIndex=11  }, { type= "text", value= "\nb", startIndex = 17, endIndex = 18 } }},
  { template = "a\n {{#a}}\n{{/a}} \nb", value                  = { { type= "text", value= "a\n ", startIndex = 1, endIndex = 3 }, { type= "#", value= "a", tokens= { { value = "\n", type = "text", startIndex = 10, endIndex = 10 } }, startIndex = 4, endIndex = 9, closingTagIndex=11 }, { type= "text", value= " \nb", startIndex = 17, endIndex = 19  } }},
  { template = "a\n{{#a}}\n{{/a}}\n{{#b}}\n{{/b}}\nb", value    = { { type= "text", value= "a\n", startIndex = 1, endIndex = 2 }, { type= "#", value= "a", tokens= { { value = "\n", type = "text", startIndex = 9, endIndex = 9 } }, startIndex = 3, endIndex = 8, closingTagIndex=10 }, { value = "\n",type = "text", startIndex = 16, endIndex = 16}, { type= "#", value= "b", tokens= {{ value = "\n",type = "text", startIndex = 23, endIndex = 23}}, startIndex = 17, endIndex = 22, closingTagIndex=24 }, { type= "text", value= "\nb", startIndex = 30, endIndex = 31 } }},
  { template = "a\n {{#a}}\n{{/a}}\n{{#b}}\n{{/b}}\nb", value   = { { type= "text", value= "a\n ", startIndex = 1, endIndex = 3 }, { type= "#", value= "a", tokens= { { value = "\n", type = "text", startIndex = 10, endIndex = 10 } }, startIndex = 4, endIndex = 9, closingTagIndex=11 }, { value = "\n", type = "text", startIndex = 17, endIndex = 17 }, { type= "#", value= "b", tokens= { { value = "\n", type = "text", startIndex = 24, endIndex = 24 } }, startIndex = 18, endIndex = 23, closingTagIndex=25  }, { type= "text", value= "\nb", startIndex = 31, endIndex = 32 } }},
  { template = "a\n {{#a}}\n{{/a}}\n{{#b}}\n{{/b}} \nb", value  = { { type= "text", value= "a\n ", startIndex = 1, endIndex = 3 }, { type= "#", value= "a", tokens= { { value = "\n", type = "text", startIndex = 10, endIndex = 10 } }, startIndex = 4, endIndex = 9, closingTagIndex=11 }, { value = "\n", type = "text", startIndex = 17, endIndex = 17 }, { type= "#", value= "b", tokens= { { value = "\n", type = "text", startIndex = 24, endIndex = 24 } }, startIndex = 18, endIndex = 23, closingTagIndex=25  }, { type= "text", value= " \nb", startIndex = 31, endIndex = 33 } }},
  { template = "a\n{{#a}}\n{{#b}}\n{{/b}}\n{{/a}}\nb", value    = { { type= "text", value= "a\n", startIndex = 1, endIndex = 2 },{ type= "#", value= "a", tokens= { { type= "text", value= "\n", startIndex = 9, endIndex = 9 }, { type= "#", value= "b", tokens= { { value = "\n", type = "text", startIndex = 16, endIndex = 16 } }, startIndex = 10, endIndex = 15, closingTagIndex=17 },{ type= "text", value= "\n", startIndex = 23, endIndex = 23 } },startIndex = 3, endIndex = 8, closingTagIndex=24},{ type= "text", value= "\nb", startIndex = 30, endIndex = 31 } }},
  { template = "a\n {{#a}}{{#b}}\n{{/b}}{{/a}}b", value         = { { type= "text", value= "a\n ", startIndex = 1, endIndex = 3 }, { type= "#", value= "a", tokens= { { type= "#", value= "b", tokens= { { value = "\n", type = "text", startIndex = 16, endIndex = 16 } }, startIndex = 10, endIndex = 15, closingTagIndex=17 } }, startIndex = 4, endIndex = 9, closingTagIndex= 23 }, { type= "text", value= "b", startIndex = 29, endIndex = 29 } }},
  { template = "a\n {{#a}}{{#b}}\n{{/b}}{{/a}} \nb", value      = { { type= "text", value= "a\n ", startIndex = 1, endIndex = 3 }, { type= "#", value= "a", tokens= { { type= "#", value= "b", tokens= { { value = "\n", type = "text", startIndex = 16, endIndex = 16 } }, startIndex = 10, endIndex = 15, closingTagIndex=17 } }, startIndex = 4, endIndex = 9, closingTagIndex= 23 }, { type= "text", value= " \nb", startIndex = 29, endIndex = 31 } }},
